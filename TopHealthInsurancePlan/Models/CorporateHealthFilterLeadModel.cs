...
{
    public class CorporateHealthFilterLeadModel
    {

        [Required]
        [Display(Name = "Company Name:")]
        public String ComplayeeName { get; set; }
        [Required]
        [Display(Name = "No. of Employees:")]
        public int TotalEmployee { get; set; } = 1;
        public List<SelectListItem> TotalEmpItems { get { return GetTotalEmployeesItems(); } set { TotalEmpItems = value; } }
        [Required]
        [Display(Name = "Title:")]
        ...
        private List<SelectListItem> GetTotalEmployeesItems()
        {
            List<SelectListItem> list = new List<SelectListItem>()
            {
                new SelectListItem { Text= "0-99" , Value= "1"},
                new SelectListItem { Text= "100-499" , Value= "2"},
                new SelectListItem { Text= "500-999" , Value= "3"},
                new SelectListItem { Text= "1000+" , Value= "4"},
                };
